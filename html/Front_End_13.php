...
Look at the image carefully and answer a question.

<div class="container">
  <form action="#" method="post">
    <div class="row">
      <div class="col-25">
        <label for="quest17">What emotion does the image represent</label>
      </div>
      <div class="col-75">
        <select id="quest17" name="q17">
