...
<h2>Think for a moment about your future and answer the question</h2>
<div class="container">
  <form action="#" method="post">
    <div class="row">
      <div class="col-25">
        <label for="quest13">How do you see your future?</label>
      </div>
      <div class="col-75">
        <select id="quest13" name="q13">
