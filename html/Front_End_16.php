...
<div class="container">
  <form action="#" method="post">
    <div class="row">
      <div class="col-25">
        <label for="quest20">How well do you sleep at night?</label>
      </div>
      <div class="col-75">
        <select id="quest20" name="q20">
          <option value="0">I sleep 7 -8 hours</option>
          <option value="1">I wake up everynight aroun 4 or 5am</option>
