...
<div class="container">
  <form action="#" method="post">
    <div class="row">
      <div class="col-25">
        <label for="quest27"font="bold"style="font-size:20px; width: 100px, height:40px;">Which statement best describes you?</label>
        <br>
      </div>
      <div class="col-75">
...
<?php
    ...
    try {
        ...
        $sql = "UPDATE answers SET question27='" . $q27 . "' " 
