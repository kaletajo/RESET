...
<div class="container">
  <form action="#" method="post">
    <div class="row">
      <div class="col-25">
        <label for="quest44" font="bold"style="font-size:20px; width: 100px, height:40px;">Select an answer</label>
      </div>
      <div class="col-75">
        <select id="quest44" name="q44" font="bold"style="font-size:20px; width: 100px, height:40px;">
    ...
    try {
       ...
       // Close database connection
        ...
        if(isset($_SESSION['username'])){
          // Go to next page
          header("location: Front_End_41.php");
        }
    }
